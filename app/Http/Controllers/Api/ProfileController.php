...
class ProfileController extends Controller
{
    ...
    public function updateImage(Request $request): JsonResponse
    {
        ...
        $user->update(['profile_image' => $request->file('image')->store('profile-images', 'public')]);
    ...
    public function updateInfo(Request $request): JsonResponse
    {
        ...
        $data = array_filter($validated, fn ($v, $k) => $k === 'preferred_languages' || ($v !== null && $v !== ''), ARRAY_FILTER_USE_BOTH);
